<template>
  <div v-if="deputy" id="deputy" class="u-margin-bottom-10 c-deputy">
        ...
        <div class="o-grid__col u-12 u-4@sm">
          <div class="c-deputy__image_container">
            ...
            <div class="c-deputy__links">
              <social-icon v-if="deputy.hasOwnProperty('email')" :link="`mailto:${deputy.email}?subject=Contacto a través de qhld.es`" icon="mail"></social-icon>
    ...
    <div v-if="deputy.footprint_by_topics.length > 0" class="o-container o-section">
      ...
      <barchart :entity="deputy" entityType="deputy" :result="deputy.footprint_by_topics.slice(0, 5)" />
      <footprint-info />
    </div>
    ...
    <save-alert v-show="use_alerts" :searchparams="{deputy: deputy.name}" :text="deputy.name"/>
  </div>
