<template>
  <div>
    <div id="dashboard" class="o-container o-section u-margin-bottom-10">
      <tipi-header :title="'Métricas'" :subtitle="'Elige una temática TIPI y descubre las principales magnitudes de la actividad del Congreso de los Diputados sobre ella'"/>
