                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" id="dicts" name="dicts">
                                        <option value="">Todos</option>
                                                ...
                                                <option value="personas sin hogar">personas sin hogar</option>
                                                <option value="población gitana">población gitana</option>
                                                <option value="población reclusa">población reclusa</option>
                                                <option value="protección social">protección social</option>
                                                <option value="sanidad">sanidad</option>
                                                <option value="transparencia y acceso a información">transparencia y acceso a información</option>
