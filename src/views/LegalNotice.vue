    ...
    <div id="legal-notice" class="o-container o-section u-margin-bottom-10">
      <div class="o-grid">
        ...
        <div class="o-grid__col u-12 u-8@sm">
          <table><thead><tr><th>TITULAR DEL SITIO WEB</th></tr></thead><tbody><tr><td><strong>DENOMINACIÓN SOCIAL:</strong> FUNDACIÓN SALVADOR SOLER MUNDO JUSTO</td></tr><tr><td><strong>CIF:</strong> G85959666</td></tr><tr><td><strong>DOMICILIO SOCIAL:</strong> CARDENAL HERRERA ORIA 63, 3 IZDA, 28047, MADRID</td></tr><tr><td><strong>CONTACTO:</strong> <br>Teléfono: 917314873 <br> Email: <a href="mailto:coordinacion@unmundosalvadorsoler.org">coordinacion@unmundosalvadorsoler.org</a></td></tr><tr><td><strong>DATOS DE INSCRIPCIÓN EN EL REGISTRO DE FUNDACIONES:</strong> <br>Inscrita el catorce de diciembre de dos mil diez en el Registro de Fundaciones del Ministerio de Cultura , con el número cronológico 962</td></tr></tbody></table>
          ...
          <h3 id="propiedad-intelectual-e-industrial"><a href="#propiedad-intelectual-e-industrial" aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Propiedad intelectual e industrial</h3>
          <p>Todas las marcas, nombres comerciales o cualquier otro signo distintivo son propiedad de FSS o de sus legítimos propietarios, quedando reservados todos los derechos sobre los mismos.</p>
          <p>El contenido, así como la información objeto de propiedad intelectual cuya titularidad corresponda a FSS estará sujeta (salvo que no se especifique expresamente otra cosa en un contenido específico) a la licencia Creative Commons “By-SA 3.0” que aparece en la página principal.</p>
          <h3 id="enlaces"><a href="#enlaces" aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Enlaces</h3>
          <p>FSS no asume ninguna responsabilidad sobre los enlaces externos que, en su caso, pudieran incluirse en el portal, ya que no tiene ningún tipo de control sobre los mismos, por lo que el Usuario accede bajo su exclusiva responsabilidad al contenido y en las condiciones de uso que rijan en los mismos.</p>
          <h3 id="política-de-privacidad"><a href="#pol%C3%ADtica-de-privacidad" aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Política de privacidad</h3>
          <p>FSS protege los datos personales según lo establecido en la Ley Orgánica de Protección de Datos y el Reglamento de Medidas de Seguridad. La información sobre la protección de datos personales se encuentra recogida en la Política de Privacidad.</p>
          <h3 id="duración-y-terminación"><a href="#duraci%C3%B3n-y-terminaci%C3%B3n" aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Duración y terminación</h3>
          <p>La web tiene, en principio, una duración indefinida. FSS, no obstante, está autorizada para dar por terminada o suspender la web en cualquier momento. Cuando ello sea razonablemente posible, FSS advertirá previamente sobre la terminación o suspensión de la Plataforma.</p>
          <h3 id="jurisdicción-y-legislación-aplicable"><a href="#jurisdicci%C3%B3n-y-legislaci%C3%B3n-aplicable" aria-hidden="true" tabindex="-1"><span class="icon icon-link"></span></a>Jurisdicción y legislación aplicable</h3>
          <p>Las presentes Condiciones se regirán por la legislación española. En caso de cualquier discrepancia las partes se someten a la jurisdicción de los Juzgados y Tribunales de Madrid con expresa renuncia a cualquier otro fuero que pudiera corresponderles, salvo que por imperativo legal corresponda otro distinto.</p>
        </div>
      </div>
    </div>
  </div>
