      ...
      <div class="o-grid">
        <div class="o-grid__col u-8@sm u-offset-2@sm">
          ...
          <div class="u-text-center">
            <router-link class="c-button c-button--primary" :to="{name: 'mediakit'}">Visit our Mediakit</router-link>
          </div>
        </div>
      </div>
    </div>
